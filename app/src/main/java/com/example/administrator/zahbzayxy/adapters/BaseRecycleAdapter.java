...
public  abstract  class BaseRecycleAdapter<T> extends RecyclerView.Adapter<BaseRecycleAdapter.BaseViewHolder>{
    ...
    protected     RvItemDeleteOnclickListener mRvItemDeleteOnclickListener;

    public RvItemDeleteOnclickListener getmRvItemDeleteOnclickListener() {
        return mRvItemDeleteOnclickListener;
    }

    public void setmRvItemDeleteOnclickListener(RvItemDeleteOnclickListener mRvItemDeleteOnclickListener) {
        this.mRvItemDeleteOnclickListener = mRvItemDeleteOnclickListener;
    }

    public RvItemOnclickListener getmRvItemOnclickListener() {
        return mRvItemOnclickListener;
    }

    public void setmRvItemOnclickListener(RvItemOnclickListener mRvItemOnclickListener) {
        this.mRvItemOnclickListener = mRvItemOnclickListener;
    }




    public interface  RvItemDeleteOnclickListener{
    ...
    public interface  RvItemOnclickListener{
        ...
        void RvItemOnclick(String position);
    }
