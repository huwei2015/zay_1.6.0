 ...
 * HYY 线下课
 */
public class NavOfflineCourseFragment extends Fragment{
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.activity_offline_course,container,false);
        initView();
        getSP();
        adapter = new OfflineCourseAdapter(totalList, mContext, token);
    ...
    private void initView() {
        ...
        isrecmmendTV=view.findViewById(R.id.recommendTV);
