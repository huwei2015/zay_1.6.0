 ...
 * Time 14:17.
 */
public class PdfFragment extends Fragment implements PullToRefreshListener {
    private View view;
    ...
    private void initView() {
        ...
        pullToRefreshRecyclerView = view.findViewById(R.id.pdf_recyclerView);
...
//        pullToRefreshRecyclerView.onRefresh();
    ...
    private void initPullToRefreshListView() {
        ...
        allFileInterface.getAllFileData(currentPage,pageSize,4,token).enqueue(new Callback<AllFileBean>() {
            @Override
