 ...
 */
public class SearchJungleListFragment extends Fragment {
    ...
    public SearchJungleListFragment() {
    ...
    private void downLoadData(int pager,final boolean isPull) {
        ...
        aClass.getSearchTestResultPath(token, keyword, quesLibId, 3, 10, pager).enqueue(new Callback<SearchTestBean>() {
            @Override
