...
public class MyOffLineCourseLearnAdapter extends RecyclerView.Adapter<MyOffLineCourseLearnAdapter.OffLineCourseViewHolder> {
    ...
    public MyOffLineCourseLearnAdapter(Context context, List<DownloaderWrapper> downloadInfos) {
