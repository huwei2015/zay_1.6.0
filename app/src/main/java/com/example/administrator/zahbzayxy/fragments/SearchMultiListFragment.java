 ...
 */
public class SearchMultiListFragment extends Fragment {
    Unbinder unbinder;
    ...
    public SearchMultiListFragment() {
    ...
    private void downLoadData(int pager,final boolean isPull) {
        ...
        aClass.getSearchTestResultPath(token, keyword, quesLibId, 2, 10, pager).enqueue(new Callback<SearchTestBean>() {
            @Override
