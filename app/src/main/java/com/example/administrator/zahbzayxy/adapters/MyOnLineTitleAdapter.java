...
public class MyOnLineTitleAdapter extends Indicator.IndicatorAdapter {
    ...
    public MyOnLineTitleAdapter(Context context, List<LearnNavigationBean.LearnListBean> dataList, Indicator indicator) {
        super();
