 ...
 * Time 18:45.
 */
public class FreeLessonSecondExpandedChildAdapter extends BaseAdapter {
    ...
    public FreeLessonSecondExpandedChildAdapter( List<PMyLessonPlayBean.DataBean.ChildCourseListBean.ChapterListBean.SelectionListBean> list, Context mContext,int getSelectionId,int courseId, String userCourseId, String imagePath) {
