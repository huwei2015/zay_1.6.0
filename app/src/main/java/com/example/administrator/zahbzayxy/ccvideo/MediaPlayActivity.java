...
public class MediaPlayActivity extends AppCompatActivity implements DWMediaPlayer.OnBufferingUpdateListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayWeakReference = new WeakReference<MediaPlayActivity>(this);
        // 隐藏标题
...
//                                                currentPosition = selectionListBean.getPlayTime()*1000;
                        ...
                        Toast.makeText(MediaPlayActivity.this, "" + errMsg, Toast.LENGTH_SHORT).show();
                    }
                }
            }
            ...
            public void onFailure(Call<PMyLessonPlayBean> call, Throwable t) {
                Toast.makeText(MediaPlayActivity.this, "网路问题", Toast.LENGTH_SHORT).show();
            }
        });
    }

    PLessonDirectoryFragment directoryFragment;
    ...
    private void initFragment() {
        ...
        directoryFragment = new PLessonDirectoryFragment(new MyInterface.ItemClickedListener() {
            @Override
...
//                                Toast.makeText(MediaPlayActivity.this, "保存播放时长失败", Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(Call<PLessonPlayTimeBean> call, Throwable t) {
                        if (!isLocalPlay) {
                            Toast.makeText(MediaPlayActivity.this, "网络问题", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
