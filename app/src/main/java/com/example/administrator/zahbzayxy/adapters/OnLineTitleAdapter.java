...
public class OnLineTitleAdapter extends Indicator.IndicatorAdapter {
    ...
    public OnLineTitleAdapter(Context context, List<LearnNavigationBean.LearnListBean> dataList, Indicator indicator) {
        super();
