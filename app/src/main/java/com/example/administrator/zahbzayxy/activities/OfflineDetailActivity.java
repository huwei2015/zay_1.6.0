...
public class OfflineDetailActivity extends BaseActivity {
    ...
    private OfflineCourseDetailAdapter pageAdapter;
    //头布局中的内容
  ...
  TextView priceTwo_tv;
    ...
    private void initHeadView() {
       ...
       int courseId = getIntent().getIntExtra("courseId",0);
        ...
        aClass.getOfflineCourseDetail(courseId).enqueue(new Callback<OfflineCoursePOBean>() {
            @Override
                ...
                if (response != null && body != null) {
                    ...
                    if (data != null) {
                        ...
                        if (courseDesc != null) {
                            ...
                            String courseImagePath = courseDesc.getImagePath();
                            ...
                            String teachers = courseDesc.getTeacherNames();
                            if (!TextUtils.isEmpty(teachers)) {
                                teacher_tv.setText("课程讲师:" + teachers);
                            }

                            if (courseImagePath != null) {
                                Picasso.with(OfflineDetailActivity.this).load(courseImagePath).placeholder(R.mipmap.loading_png)
    ...
    private void initFragment() {
        titlesList.add("课程概述");
        OfflineDetailFragment titleFragment=new OfflineDetailFragment();
        fragmentList.add(titleFragment);
        fragmentManager=getSupportFragmentManager();
        pageAdapter=new OfflineCourseDetailAdapter(fragmentManager,fragmentList,titlesList);
        ...
        buyCar_iv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(OfflineDetailActivity.this,BuyCarActivity.class);
                    ...
                    public void onResponse(Call<SuccessBean> call, Response<SuccessBean> response) {
                        ...
                        if (response!=null&&body!=null){
                            ...
                            if (code.equals("99999")){
                                Toast.makeText(OfflineDetailActivity.this,"系统异常",Toast.LENGTH_SHORT).show();
                            }
                            else if (code.equals("00003")){
                                Toast.makeText(OfflineDetailActivity.this,"用户未登录",Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(OfflineDetailActivity.this,"该课程已加入购物车",Toast.LENGTH_SHORT).show();
                            }
                            else if (code.equals("00000")&data==true){
                                Toast.makeText(OfflineDetailActivity.this,"加入购物车成功",Toast.LENGTH_SHORT).show();
                            }
                    ...
                    public void onResponse(Call<BuyInstanceBean> call, Response<BuyInstanceBean> response) {
                        ...
                        if (body != null) {
                            if (code.equals("00003")) {
                                ...
                                Toast.makeText(OfflineDetailActivity.this, "用户已购买该课程", Toast.LENGTH_SHORT).show();
                            } else if (code.equals("99999")) {
                                Toast.makeText(OfflineDetailActivity.this, "系统异常", Toast.LENGTH_SHORT).show();
                            } else if (code.equals("00023")) {
                                Toast.makeText(OfflineDetailActivity.this, "该订单已存在", Toast.LENGTH_SHORT).show();
                                ...
                                if (orderNumber != null&&!TextUtils.isEmpty(pirce)) {
                                    Intent intent = new Intent(OfflineDetailActivity.this, PayUiActivity.class);
...
//                        Toast.makeText(LessonThiredActivity.this, "网络问题", Toast.LENGTH_SHORT).show();
    ...
    public void loginDialog(){
        new AlertDialog.Builder(OfflineDetailActivity.this).setTitle("请先登录再购买,去登录?")
                .setIcon(android.R.drawable.ic_dialog_info)
                .setPositiveButton("登录", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        // dialog.dismiss();
                        Intent intent=new Intent(OfflineDetailActivity.this, LoginActivity.class);
                        startActivity(intent);
                    }
                })
