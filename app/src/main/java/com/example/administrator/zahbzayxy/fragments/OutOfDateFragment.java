...
public class OutOfDateFragment extends Fragment {
    ...
    @BindView(R.id.yhj_outOfData_lv)
    ListView yhj_outOfData_lv;
    Context context;
    View view;
    ...
    private void initDownLoadData() {
        ...
        yhj_outOfData_lv.setAdapter(adapter);
        ...
        aClass.getMyYouHuiJuanData(3,token).enqueue(new Callback<YouHuiJuanBean>() {
            @Override
