...
public class ImageRadiusView  extends AppCompatImageView {

    float width, height;

    public ImageRadiusView(Context context) {
        this(context, null);
        init(context, null);
    }

    public ImageRadiusView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        init(context, attrs);
    }

    public ImageRadiusView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        radius = array.getDimensionPixelOffset(R.styleable.Custom_Round_Image_View_radiusAll, defaultRadius);
