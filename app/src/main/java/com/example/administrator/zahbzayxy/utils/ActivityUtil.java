...
//跳转的同时是否关闭
    public static void startIsFinish(Context context,Class<Activity>activityClass,boolean isFinished ){
     ...
     * @param params
     */
    /*public static void switchTo(NewMyRenZhengDetailActivity activity,Class<? extends NewMyRenZhengDetailActivity> target,NameValuePair...params){
        if( null != params ){
